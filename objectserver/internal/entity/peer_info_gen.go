...
func (z *PeerInfo) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "gprc_port":
			z.RpcPort, err = dc.ReadString()
			if err != nil {
				err = msgp.WrapError(err, "RpcPort")
				return
			}
		default:
			err = dc.Skip()
...
func (z *PeerInfo) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 4
	// write "server_id"
	err = en.Append(0x84, 0xa9, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x69, 0x64)
	if err != nil {
		return
	}
...
func (z *PeerInfo) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 4
	// string "server_id"
	o = append(o, 0x84, 0xa9, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x69, 0x64)
	...
	o = msgp.AppendString(o, z.RpcPort)
	return
}
...
func (z *PeerInfo) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "gprc_port":
			z.RpcPort, bts, err = msgp.ReadStringBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "RpcPort")
				return
			}
...
func (z *PeerInfo) Msgsize() (s int) {
	s = 1 + 10 + msgp.StringPrefixSize + len(z.ServerID) + 9 + msgp.StringPrefixSize + len(z.Location) + 10 + msgp.StringPrefixSize + len(z.HttpPort) + 10 + msgp.StringPrefixSize + len(z.RpcPort)
	return
}
