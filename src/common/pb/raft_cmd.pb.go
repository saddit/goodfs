...
var file_raft_cmd_proto_rawDesc = []byte{
	...
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x32, 0x89, 0x02, 0x0a, 0x07, 0x52, 0x61, 0x66, 0x74, 0x43,
...
var file_raft_cmd_proto_depIdxs = []int32{
	...
	6, // 7: proto.RaftCmd.Bootstrap:output_type -> proto.Response
	6, // 8: proto.RaftCmd.AddVoter:output_type -> proto.Response
	6, // 9: proto.RaftCmd.JoinLeader:output_type -> proto.Response
	6, // 10: proto.RaftCmd.AppliedIndex:output_type -> proto.Response
	6, // 11: proto.RaftCmd.Peers:output_type -> proto.Response
