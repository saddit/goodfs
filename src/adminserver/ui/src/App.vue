    ...
    <div class="flex flex-col w-full">
      <div class="inline-flex items-center py-6 px-4">
        ...
        <div class="inline-flex items-center text-gray-500">
          ...
          <PopMenu>
            <template #button>
              <span class="underline mx-1 outline-none hover:text-indigo-500 select-none transition-colors">
                {{ store.user}}
              </span>
            </template>
            <template #panel>
              <div class="grid gap-2 bg-white p-3">
                <div
                  class="inline-flex justify-center items-center rounded-lg p-2 transition duration-150 ease-in-out hover:text-indigo-600 hover:bg-indigo-50">
