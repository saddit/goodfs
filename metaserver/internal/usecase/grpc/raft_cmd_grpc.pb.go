...
func (c *raftCmdClient) Bootstrap(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedRaftCmdServer) Bootstrap(context.Context, *Request) (*Response, error) {
...
func _RaftCmd_Bootstrap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftCmdServer).Bootstrap(ctx, req.(*Request))
	}
