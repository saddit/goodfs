...
var file_raft_cmd_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x73, 0x32, 0x89, 0x02, 0x0a, 0x07, 0x52, 0x61, 0x66, 0x74, 0x43, 0x6d, 0x64, 0x12,
	...
	0x22, 0x00, 0x12, 0x2b, 0x0a, 0x05, 0x50, 0x65, 0x65, 0x72, 0x73, 0x12, 0x0f, 0x2e, 0x70, 0x72,
...
var file_raft_cmd_proto_depIdxs = []int32{
	...
	0, // 6: proto.RaftCmd.Peers:input_type -> proto.EmptyReq
	1, // 7: proto.RaftCmd.Bootstrap:output_type -> proto.Response
	1, // 8: proto.RaftCmd.AddVoter:output_type -> proto.Response
	1, // 9: proto.RaftCmd.JoinLeader:output_type -> proto.Response
	1, // 10: proto.RaftCmd.AppliedIndex:output_type -> proto.Response
	1, // 11: proto.RaftCmd.Peers:output_type -> proto.Response
